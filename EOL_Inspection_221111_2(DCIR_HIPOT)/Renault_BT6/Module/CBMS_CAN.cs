    ...
    public class CBMS_CAN
    {
            ...
            sendThread1 = new Thread(() =>
            {
                while (true)
                {
                    ...
                    if (IsSendMsg)
                    {
                        ...
                        if (time % 20 == 0)
                        {
                            SendToCAN("522", new byte[] { 0x22, 0x40, 0x0, 0xFF, 0x0, 0x0, 0x0, 0x0 });
                        }
        ...
        private void SetPCAN_BMS1(string fname)
        {
            ...
            else
            {
                ...
                mw.LogState(LogType.Info, "CAN1 Timer Started", null, true);

                mw.LogState(LogType.Success, "PCAN1 Connected", null, true);
