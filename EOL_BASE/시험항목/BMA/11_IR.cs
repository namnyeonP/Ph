...
namespace EOL_BASE
{
    ...
    public partial class MainWindow
    {
        ...
        double modulePoint_DIS1 = 0.0;
        double modulePoint_DIS2 = 0.0;
        double modulePoint_DIS3 = 0.0;
        double modulePoint_DIS4 = 0.0;
        double modulePoint_DIS5 = 0.0;
        double modulePoint_DIS6 = 0.0;
        double modulePoint_DIS7 = 0.0;
        double modulePoint_DIS8 = 0.0;
        double modulePoint_DIS9 = 0.0;
        double modulePoint_DIS10 = 0.0;
        double modulePoint_RES_CHA = 0.0;
        double modulePoint_CHA = 0.0;

        double endCurrent_DIS = 0.0;
        double endCurrent_DIS1 = 0.0;
        double endCurrent_DIS2 = 0.0;
        double endCurrent_DIS3 = 0.0;
        double endCurrent_DIS4 = 0.0;
        double endCurrent_DIS5 = 0.0;
        double endCurrent_DIS6 = 0.0;
        double endCurrent_DIS7 = 0.0;
        double endCurrent_DIS8 = 0.0;
        double endCurrent_DIS9 = 0.0;
        double endCurrent_DIS10 = 0.0;

        double endCurrent_CHA = 0.0;
        double dcirTemp = 0;

        // 20191124 Noah Choi 모듈 온도 평균값 변수 생성 
        double moduleTempAverage = 0;
        #endregion
        ...
        private DetailItems SetCellVoltagesNloggingToIndex(int p1, string dtiKey, string loggingTitle, string moduleVolt)
        {
            ...
            if(localTypes == 0 || localTypes == 1 || localTypes == 3)
            {
                ...
                dti.Reportitems.Add(cellDetailList[p1].CellVolt_7);
                dti.Reportitems.Add(cellDetailList[p1].CellVolt_8);
            }
            ...
            else if (localTypes == 4 || localTypes == 5)
            {
                ...
                dti.Reportitems.Add(cellDetailList[p1].CellVolt_7);
                dti.Reportitems.Add(cellDetailList[p1].CellVolt_8);
                dti.Reportitems.Add(cellDetailList[p1].CellVolt_9);
                dti.Reportitems.Add(cellDetailList[p1].CellVolt_10);
            } 
            var logstr =loggingTitle + moduleVolt;
            int cnt=1;
            foreach (var item in dti.Reportitems)
            {
                logstr += ",CELL" + cnt.ToString() +" :"+ item.ToString(); ;
                cnt++;
            }
        ...
        void InitDCIRVariables()
        {
            ...
            mTotalRunCountDCIR = GetTotalRunCountDCIR();
            mLastStepRunCountDCIR = GetStepRunCountDCIR(5);
        }
        ...
        Thread dp_disc, dp_char, dp_rest_bef_disc, dp_rest_aft_disc, dp_rest_aft_char, dp_rest_aft_char_10s, dp_rest_aft_char_20s, dp_rest_aft_char_30s, dp_rest_aft_char_40s;
